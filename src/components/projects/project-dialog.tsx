...
/* ─── tech badge ─── */
function TechBadge({ tech, onRemove }: { tech: string; onRemove: () => void }) {
    return (
        <span
            ...
            >
                ...
                {[
                    ...
                    <div
                        ...
                        style={{ borderColor: "#00ff88", opacity: 0.6 }}
                    />
                ))}
                ...
                >
                    ...
                    <DialogHeader className="space-y-0.5">
                        <DialogTitle
                            ...
                            style={{ color: "#e0e0ff" }}
                        >
                            {isEditing ? `_edit_project` : `_new_project`}
                        </DialogTitle>
                        <DialogDescription
                        ...
                        >
                            {isEditing
                                ...
                                : "Initialize a new project entry for your portfolio."}
                        </DialogDescription>
                    </DialogHeader>
                </div>
                ...
                >
                    ...
                    {/* TECH STACK */}
                    <div>
                        <SectionHeader icon={Cpu} label="Tech Stack" />
                        <div className="space-y-3">
                            <div className="flex gap-2">
                                <input
                                    className={inputClass}
                                    placeholder="React, Next.js, Tailwind — press Enter to add"
                                    value={techInput}
                                    onChange={(e) =>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <input
                                    type="number"
                                    className={`${inputClass} w-16 h-8 text-center px-2 py-1 text-xs`}
                                    {...register("sortOrder", {
                                        valueAsNumber: true,
                                    })}
                                />
